	...
	render: function() {
		...
		switch ( icon ) {
			...
			case 'gridicons-reader-follow':
				svg = <svg className={ iconClass } height={ this.props.size } width={ this.props.size } onClick={ this.props.onClick } xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><g><path d="M20 16v-3h-2v3h-3v2h3v3h2v-3h3v-2"/><path d="M16 11h4V2H2v14c0 1.1.9 2 2 2h9v-4h3v-3zm-8 2H4v-1h4v1zm3-2H4v-1h7v1zm0-2H4V8h7v1zM4 6V4h14v2H4z"/></g></svg>;
				break;
			case 'gridicons-reader-following':
				svg = <svg className={ iconClass } height={ this.props.size } width={ this.props.size } onClick={ this.props.onClick } xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><g><path d="M21.6 12.1l-6.1 6.1-2.1-2.2-1.4 1.4 3.5 3.6 7.5-7.5"/><path d="M15.5 15.3l4.5-4.5V2H2v14c0 1.1.9 2 2 2h4.5l4.9-4.8 2.1 2.1zM4 13v-1h4v1H4zm7-2H4v-1h7v1zm0-2H4V8h7v1zm7-3H4V4h14v2z"/></g></svg>;
				break;
